...
// MsgTestDoc.cpp : CMsgTestDoc 类的实现
//
...
// 缩略图的支持
void CMsgTestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CMsgTestDoc::InitializeSearchContent()
{
...
void CMsgTestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
void CMsgTestDoc::SetTitle(LPCTSTR lpszTitle)
{
	// TODO: 在此添加专用代码和/或调用基类

	 CDocument::SetTitle(L"作业1");
}
